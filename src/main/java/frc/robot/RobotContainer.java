...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand(
        "Elevator L4", elevator.toTargetCommand(ElevatorConstants.elevatorMaxHeightInch));
    ...
    // The warning will always be active if connected to FMS (actual match)
  ...
  private void configureButtonBindings() {
    ...
    // Lock to 50° when A button is held
    controller
        .a()
        .whileTrue(
    ...
    // POV up sets elevator to max height
    controller.povUp().onTrue(elevator.toTargetCommand(ElevatorConstants.elevatorMaxHeightInch));

    // POV down sets elevator to min height
    controller.povDown().onTrue(elevator.toTargetCommand(ElevatorConstants.elevatorMinHeightInch));
